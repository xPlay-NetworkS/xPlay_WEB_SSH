...
wget https://github.com/xPlay-NetworkS/xPlay_WEB_SSH/raw/main/install/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/xPlay-NetworkS/xPlay_WEB_SSH/raw/main/install/sshplus.zip.002 > /dev/null 2>&1
wget https://github.com/xPlay-NetworkS/xPlay_WEB_SSH/raw/main/install/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/xPlay-NetworkS/xPlay_WEB_SSH/raw/main/install/sincpainel.zip > /dev/null 2>&1
