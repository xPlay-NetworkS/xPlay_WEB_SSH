...
wget https://github.com/xPlay-NetworkS/xPlay_WEB_SSH/raw/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/xPlay-NetworkS/xPlay_WEB_SSH/raw/main/install/verifatt.sh > /dev/null 2>&1
wget https://github.com/xPlay-NetworkS/xPlay_WEB_SSH/raw/main/install/verpweb > /dev/null 2>&1
wget https://github.com/xPlay-NetworkS/xPlay_WEB_SSH/raw/main/install/verweb > /dev/null 2>&1
wget https://github.com/xPlay-NetworkS/xPlay_WEB_SSH/raw/main/install/whatsapp.sh > /dev/null 2>&1
...
wget https://github.com/xPlay-NetworkS/xPlay_WEB_SSH/raw/main/install/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "XPLAY WEB SSH" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @AndradeS_xPlay\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://github.com/xPlay-NetworkS/xPlay_WEB_SSH/raw/main/install/chave") &>/dev/null
